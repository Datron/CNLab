...
set opt(wrap) 100 ;
set opt(srcTrace) is ;
set opt(desTrace) bs2 ;
#default downlink bandwidth in bps
set bwDL(gsm) 9600
#set default downlink propogation delay in seconds
set propDL(gsm) .500
...
proc cell_topo {} {
	...
	$ns duplex-link $nodes(lp) $nodes(is) 3Mbps 10ms DropTail
