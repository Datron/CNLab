...
#getrc and raw2xg is in ns2.35 directory,have to provide the complete path for the files in the program
set GETRC "/root/ns-allinone-2.35/ns-2.35/bin/getrc"
set RAW2XG "/root/ns-allinone-2.35/ns-2.35/bin/raw2xg"
exec $GETRC -s $sid -d $did -f 0 lab51.tr | \
$RAW2XG -s 0.01 -m $wrap -r > plot1.xgr
exec $GETRC -s $did -d $sid -f 0 lab51.tr | \
$RAW2XG -a -s 0.01 -m $wrap >> plot1.xgr
exec xgraph -x time -y packets plot1.xgr &
exit 0
}
$ns at $stop "stop"
$ns run
